...
export const metadata: Metadata = {
  title: `سطحة الحمراء جدة | خدمة نقل السيارات السريعة`,
  description: `خدمة سطحة الحمراء جدة موثوقة وسريعة. نقل السيارات والطوارئ في حي الحمراء على مدار الساعة. فريق محترف ومعدات حديثة`,
  keywords: `سطحة الحمراء جدة, سطحة الحمراء, سطحة, جدة, الحمراء, نقل سيارات`,
  alternates: {
    canonical: `https://satah-jeddah.com/satah-al-hamra-jeddah`,
  },
  openGraph: {
    title: `سطحة الحمراء جدة`,
    description: `خدمة سطحة موثوقة في حي الحمراء جدة`,
    url: `https://satah-jeddah.com/satah-al-hamra-jeddah`,
    type: "website",
    locale: "ar_SA",
  },
  other: {
...
export default async function SatahAlHamraJeddahPage() {
  if (!district) {
    notFound()
  }
  ...
  const breadcrumbItems = [
    ...
    { label: `سطحة ${district.name} جدة`, href: `/satah-al-hamra-jeddah` },
  ]
