...
const district = getDistrictBySlug("al-khalidiyah")

const alKhalidiyahFaqs2 = [
  {
...
export const metadata: Metadata = {
  title: `سطحة الخالدية جدة | خدمة نقل السيارات السريعة`,
  description: `خدمة سطحة الخالدية جدة موثوقة وسريعة. نقل السيارات والطوارئ في حي الخالدية على مدار الساعة. فريق محترف ومعدات حديثة`,
  keywords: `سطحة الخالدية جدة, سطحة الخالدية, سطحة, جدة, الخالدية, نقل سيارات`,
  alternates: {
    canonical: `https://satah-jeddah.com/satah-al-khalidiyah-jeddah`,
  },
  openGraph: {
    title: `سطحة الخالدية جدة`,
    description: `خدمة سطحة موثوقة في حي الخالدية جدة`,
    url: `https://satah-jeddah.com/satah-al-khalidiyah-jeddah`,
    type: "website",
    locale: "ar_SA",
  },
  other: {
    "geo.region": "SA-02",
    "geo.placename": `الخالدية, جدة`,
    "geo.position": `${district?.coordinates.lat};${district?.coordinates.lng}`,
  },
}

export default async function SatahAlKhalidiyahJeddahPage() {
  if (!district) {
    notFound()
  }
  ...
  const breadcrumbItems = [
    ...
    { label: `سطحة ${district.name} جدة`, href: `/satah-al-khalidiyah-jeddah` },
  ]
  ...
  const pageSchemas = [
    ...
    getFAQPageSchema(alKhalidiyahFaqs2),
  ]
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <section className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <div className="space-y-4">
                {alKhalidiyahFaqs2.map((faq, index) => (
          ...
          <aside className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <h3 className="text-lg font-bold mb-4 text-gray-900">خريطة {district.name}</h3>
