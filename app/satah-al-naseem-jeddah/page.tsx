...
const district = getDistrictBySlug("al-naseem")
...
export const metadata: Metadata = {
  title: `سطحة النسيم جدة | خدمة نقل السيارات السريعة`,
  description: `خدمة سطحة النسيم جدة موثوقة وسريعة. نقل السيارات والطوارئ في حي النسيم على مدار الساعة. فريق محترف ومعدات حديثة`,
  keywords: `سطحة النسيم جدة, سطحة النسيم, سطحة, جدة, النسيم, نقل سيارات`,
}

export default async function SatahAlNaseemJeddahPage() {
  if (!district) {
    notFound()
  }
  ...
  const breadcrumbItems = [
    ...
    { label: `سطحة ${district.name} جدة`, href: `/satah-al-naseem-jeddah` },
  ]
  ...
  const pageSchemas = [
    ...
    getFAQPageSchema(alNaseemFaqs2),
  ]
          ...
          <div className="lg:col-span-2">
            <article className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                حي {district.name}. نحن نفهم احتياجات المنطقة ونقدم حلول نقل مخصصة. حي النسيم يتميز بقربه من الجامعات
                والمراكز الطبية المهمة.
              </p>
              <p className="text-gray-700 mb-4">
                {district.description}. فريقنا مدرب خصيصاً للتعامل مع طرق وظروف حي {district.name}
                لضمان خدمة سريعة وآمنة. نغطي جميع المناطق من الكورنيش إلى الجامعات.
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                  ...
                  <p className="text-yellow-700">
                    تجنب الحركة في طريق الملك عبدالعزيز وشارع فلسطين خلال ساعات الذروة الصباحية والمسائية.
                  </p>
                </div>
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                  <h3 className="font-semibold text-blue-800 mb-2">مواقف السيارات</h3>
                  <p className="text-blue-700">
                    استفد من المواقف المجانية في الجامعات والمستشفيات، واحذر من المواقف المدفوعة في المناطق التجارية.
                  </p>
                </div>
                <div className="bg-green-50 border-l-4 border-green-400 p-4">
                  <h3 className="font-semibold text-green-800 mb-2">خدمة السطحة السريعة</h3>
                  <p className="text-green-700">
                    نحن متواجدون بشكل دائم قرب المناطق الحيوية في {district.name} لضمان وصول سريع في حالات الطوارئ.
                  </p>
                </div>
              </div>
            </section>
