...
const alRawdahFaqs2 = [
  {
    question: "هل تقدمون خدمة سطحة سريعة في الروضة جدة؟",
    answer: "نعم، نلتزم بالوصول السريع خلال 15-30 دقيقة في حي الروضة بجدة لخدمة طوارئ السيارات.",
  },
  {
    question: "ما هي ساعات عمل سطحة الروضة جدة؟",
    answer: "نعمل على مدار 24 ساعة، 7 أيام في الأسبوع، لتقديم خدمة سطحة في أي وقت تحتاجها.",
  },
  {
    question: "هل يمكنني الاعتماد على سطحة الروضة جدة لنقل سيارتي الفاخرة؟",
    answer:
      "بالتأكيد، فريقنا مدرب ومجهز بأحدث المعدات لنقل جميع أنواع السيارات بأمان تام، بما في ذلك السيارات الفاخرة.",
  },
]

export const metadata: Metadata = {
  title: `سطحة الروضة جدة | خدمة نقل السيارات السريعة`,
  description: `خدمة سطحة الروضة جدة موثوقة وسريعة. نقل السيارات والطوارئ في حي الروضة على مدار الساعة. فريق محترف ومعدات حديثة`,
  keywords: `سطحة الروضة جدة, سطحة الروضة, سطحة, جدة, الروضة, نقل سيارات, سطحه جده الروضه, سحب سيارات الروضه`,
  alternates: {
    canonical: `https://satah-jeddah.com/satah-al-rawdah-jeddah`,
  },
  openGraph: {
    title: `سطحة الروضة جدة`,
    description: `خدمة سطحة موثوقة في حي الروضة جدة`,
    url: `https://satah-jeddah.com/satah-al-rawdah-jeddah`,
    type: "website",
    locale: "ar_SA",
  },
  other: {
...
export default async function SatahAlRawdahJeddahPage() {
  if (!district) {
    notFound()
  }
  ...
  const breadcrumbItems = [
    ...
    { label: `سطحة ${district.name} جدة`, href: `/satah-al-rawdah-jeddah` },
  ]
  ...
  const pageSchemas = [
    ...
    getFAQPageSchema(alRawdahFaqs2),
  ]
          ...
          <div className="lg:col-span-2">
            <article className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                حي {district.name}. نحن نفهم احتياجات المنطقة ونقدم حلول نقل مخصصة. حي الروضة هو أحد الأحياء الحيوية في
                جدة، ويشهد حركة مرور كثيفة، مما يزيد من الحاجة لخدمات السطحة السريعة والموثوقة.
              </p>
              <p className="text-gray-700 mb-4">
                {district.description}. فريقنا مدرب خصيصاً للتعامل مع طرق وظروف حي {district.name}
                لضمان خدمة سريعة وآمنة. نغطي جميع الطرق الرئيسية والفرعية، بما في ذلك الطرق المؤدية إلى المناطق التجارية
                المحيطة.
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                  ...
                  <p className="text-yellow-700">
                    تجنب الحركة في الشوارع الرئيسية خلال ساعات الذروة (7-9 صباحاً و 5-7 مساءً) لتجنب الازدحام.
                  </p>
                </div>
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                  <h3 className="font-semibold text-blue-800 mb-2">مواقف السيارات</h3>
                  <p className="text-blue-700">
                    تتوفر مواقف مجانية في المولات الكبيرة، بينما قد تحتاج لدفع رسوم في بعض المناطق التجارية.
                  </p>
                </div>
            ...
            <section className="bg-white rounded-lg shadow-md p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">تقييمات العملاء حول سطحة الروضة جدة</h2>
            ...
            {/* FAQ Section */}
            <section className="bg-white rounded-lg shadow-md p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-900">أسئلة متكررة عن سطحة الروضة جدة</h2>
              <div className="space-y-4">
                {alRawdahFaqs2.map((faq, index) => (
