...
const district = getDistrictBySlug("al-hamra")
...
export const metadata: Metadata = {
  title: `سطحة جدة الحمراء | خدمة نقل السيارات في حي الحمراء`,
  description: `خدمة سطحة موثوقة وسريعة في حي الحمراء جدة. نقل السيارات والطوارئ على مدار الساعة. اتصل الآن للحصول على خدمة فورية`,
  keywords: `سطحة جدة الحمراء, سطحة الحمراء, سطحة, جدة, الحمراء, نقل سيارات`,
  alternates: {
    canonical: `https://satah-jeddah.com/satah-jeddah-al-hamra`,
  },
  openGraph: {
    title: `سطحة جدة الحمراء`,
    description: `خدمة سطحة موثوقة في حي الحمراء جدة`,
    url: `https://satah-jeddah.com/satah-jeddah-al-hamra`,
    type: "website",
    locale: "ar_SA",
  },
  other: {
    "geo.region": "SA-02",
    "geo.placename": `الحمراء, جدة`,
    "geo.position": `${district?.coordinates.lat};${district?.coordinates.lng}`,
  },
}

export default async function SatahJeddahAlHamraPage() {
  if (!district) {
    notFound()
  }
  ...
  const breadcrumbItems = [
    ...
    { label: `سطحة جدة ${district.name}`, href: `/satah-jeddah-al-hamra` },
  ]
