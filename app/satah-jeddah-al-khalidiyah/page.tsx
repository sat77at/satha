...
export const metadata: Metadata = {
  title: `سطحة جدة الخالدية | خدمة نقل السيارات في حي الخالدية`,
  description: `خدمة سطحة موثوقة وسريعة في حي الخالدية جدة. نقل السيارات والطوارئ على مدار الساعة. اتصل الآن للحصول على خدمة فورية`,
  keywords: `سطحة جدة الخالدية, سطحة الخالدية, سطحة, جدة, الخالدية, نقل سيارات`,
  alternates: {
    canonical: `https://satah-jeddah.com/satah-jeddah-al-khalidiyah`,
  },
  openGraph: {
    title: `سطحة جدة الخالدية`,
    description: `خدمة سطحة موثوقة في حي الخالدية جدة`,
    url: `https://satah-jeddah.com/satah-jeddah-al-khalidiyah`,
    type: "website",
    locale: "ar_SA",
  },
  other: {
...
export default async function SatahJeddahAlKhalidiyahPage() {
  if (!district) {
    notFound()
  }
  ...
  const breadcrumbItems = [
    ...
    { label: `سطحة جدة ${district.name}`, href: `/satah-jeddah-al-khalidiyah` },
  ]
  ...
  const pageSchemas = [
    ...
    getFAQPageSchema(alKhalidiyahFaqs),
  ]
          ...
          <div className="lg:col-span-2">
            ...
            <section className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <div className="space-y-4">
                {alKhalidiyahFaqs.map((faq, index) => (
