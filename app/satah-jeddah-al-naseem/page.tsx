...
export const metadata: Metadata = {
  title: `سطحة جدة النسيم | خدمة نقل السيارات في حي النسيم`,
  description: `خدمة سطحة موثوقة وسريعة في حي النسيم جدة. نقل السيارات والطوارئ على مدار الساعة. اتصل الآن للحصول على خدمة فورية`,
  keywords: `سطحة جدة النسيم, سطحة النسيم, سطحة, جدة, النسيم, نقل سيارات`,
}

export default async function SatahJeddahAlNaseemPage() {
  if (!district) {
    notFound()
  }
  ...
  const breadcrumbItems = [
    ...
    { label: `سطحة جدة ${district.name}`, href: `/satah-jeddah-al-naseem` },
  ]
          ...
          <div className="lg:col-span-2">
            <article className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                <em>سطحة</em> متخصصة وسريعة لجميع سكان وزوار هذا الحي المميز. يتميز حي النسيم بموقعه الاستراتيجي وقربه
                من الجامعات والمراكز الطبية المهمة.
              </p>
              <p className="text-gray-700 mb-4">
                {district.description}. خدمتنا تشمل نقل السيارات المتعطلة، سيارات الحوادث، والمركبات التي تحتاج صيانة
                طارئة. نغطي جميع المناطق من كورنيش جدة إلى الجامعات والمستشفيات.
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                  ...
                  <p className="text-yellow-700">
                    تجنب الحركة في طريق الملك عبدالعزيز وشارع فلسطين خلال ساعات الذروة (7-9 صباحاً و 5-7 مساءً).
                  </p>
                </div>
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                  <h3 className="font-semibold text-blue-800 mb-2">مواقف السيارات</h3>
                  <p className="text-blue-700">
                    تتوفر مواقف مجانية في مول العرب ومستشفى الملك فهد، مع مواقف مدفوعة في المناطق التجارية.
                  </p>
                </div>
                <div className="bg-green-50 border-l-4 border-green-400 p-4">
                  <h3 className="font-semibold text-green-800 mb-2">خدمة السطحة السريعة</h3>
                  <p className="text-green-700">
                    نحن متواجدون بشكل دائم قرب الجامعات والمستشفيات لضمان وصول سريع للطلاب والمرضى.
                  </p>
                </div>
              </div>
            </section>
